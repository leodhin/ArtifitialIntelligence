...
# Recompensas
REWARD_EAT = 500  # Recompensa por comer
REWARD_MOVE_TOWARDS_FOOD = 10  # Recompensa por acercarse a la comida
...
REWARD_TRAPPED = -50  # Penalización fuerte por reducir demasiado el espacio disponible
